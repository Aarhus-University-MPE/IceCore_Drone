...
AddOutputFilter chunkFilter
		...
		<Item Name="Beacon release working.vi" Type="VI" URL="../../PQ12 (Linear Actuator)/PQ-12 Beacon/Beacon release working.vi"/>
		<Item Name="Bore pos (SubVI(.vi" Type="VI" URL="../../Servo/Servo demo/Bore pos (SubVI(.vi"/>
		<Item Name="Camera string test.vi" Type="VI" URL="../Camera string test.vi"/>
		<Item Name="Convert binary to image.vi" Type="VI" URL="../../../../../../Downloads/Convert binary to image.vi"/>
		<Item Name="Fuld camera med gem og billede analyse.vi" Type="VI" URL="../Fuld camera med gem og billede analyse.vi"/>
		<Item Name="H-brigde test.vi" Type="VI" URL="../../PQ12 (Linear Actuator)/H-brigde test.vi"/>
		<Item Name="JPEG_IN_MEM_RGB.vi" Type="VI" URL="../../../../../../Desktop/JPEG_IN_MEM_RGB.vi"/>
		<Item Name="Load Image From Binary File LV2012 NIVerified.vi" Type="VI" URL="../Binary image binary/Load Image From Binary File LV2012 NIVerified.vi"/>
		<Item Name="Quick release working.vi" Type="VI" URL="../../PQ12 (Linear Actuator)/PQ-12 - Quick Release/Quick release working.vi"/>
		<Item Name="Read image from usb.vi" Type="VI" URL="../../XBee/Test/Read image from usb.vi"/>
		<Item Name="Save Image As Binary File LV2012 NIVerified.vi" Type="VI" URL="../Binary image binary/Save Image As Binary File LV2012 NIVerified.vi"/>
		<Item Name="Servo demo.vi" Type="VI" URL="../../Servo/Servo demo/Servo demo.vi"/>
		<Item Name="Servo full.vi" Type="VI" URL="../../Servo/Servo demo/Servo full.vi"/>
		<Item Name="test drone.vi" Type="VI" URL="../../Servo/Servo demo/test drone.vi"/>
		<Item Name="Test send.vi" Type="VI" URL="../../XBee/Test send.vi"/>
		<Item Name="TestiLabviewLIVELowLevelv3 (1).vi" Type="VI" URL="../Mapping/TestiLabviewLIVELowLevelv3 (1).vi"/>
		<Item Name="TestiLabviewLIVELowLevelv3.vi" Type="VI" URL="../TestiLabviewLIVELowLevelv3.vi"/>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Input_PWM_main_SubVI.vi" Type="VI" URL="../../Main/SubVI/Input_PWM_main_SubVI.vi"/>
			...
			<Item Name="Servo (1 inc)(SubVI).vi" Type="VI" URL="../../Servo/Servo demo/Servo (1 inc)(SubVI).vi"/>
			<Item Name="Servo vertical (1 inc)(SubVI).vi" Type="VI" URL="../../Servo/Servo demo/Servo vertical (1 inc)(SubVI).vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build"/>
	</Item>
</Project>
